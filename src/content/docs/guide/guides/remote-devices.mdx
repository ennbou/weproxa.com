...
WePROXA can act as a proxy for any device on your local network — including physical iPhones, iPads, and Android phones — so you can inspect real app traffic the same way you inspect browser traffic on your computer.
